"""
The code uses zonal mean ERA-Interim data of surface pressure (ps) and zonal winds (u) found in /badc to 
compute the monthly values of vertically integrated angular momentum versus latitudes. This will then store
the monthly AAM values in User directory for later plotting.
"""
import time
...
base_path = os.getcwd()
era_interim_path_base = "/badc/ecmwf-era5/data/oper/an_ml/" #an_ml for analysis on model levels
