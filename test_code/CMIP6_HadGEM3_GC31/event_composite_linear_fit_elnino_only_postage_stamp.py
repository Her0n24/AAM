...
from plotting_utils import plot_lat_level_postage_stamp_5x12, plot_lat_level_monthly_stamps_10col, plot_lat_lon_monthly_stamps_10col
import tqdm
...
output_dir = f"{base_dir}/figures/postage_stamp/"
