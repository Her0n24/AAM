...
This script composite the full 4D AAM (latitude, longitude, height and time)
Results will be saved and plotted as
lat-lon
height-lat 
plots.
In these computations, the vertically integrated AAM anomaly and 
zonal mean AAM anomaly will be used.
(Standard for vertical is 150-1000 hPa)
...
AAM_FIG_DIR = ERA5_DIR / "composite_non_tracking"
AAM_DATA_DIR = Path("/work/scratch-nopw2/hhhn2/ERA5/monthly_mean/AAM/full")
CLIMATOLOGY_DIR = ERA5_DIR / "/work/scratch-nopw2/hhhn2/ERA5/climatology"
